...
echo "=========================================="
echo "SME Pipeline: Minimize → Thermal Cycling"
...
run_min() {
    ...
    # Create marker file on successful completion (in background)
...
echo "  • Logs:        logs/"
echo ""
echo "Next: Analyze SME thermal hysteresis and shape recovery"